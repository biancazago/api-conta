...
public final class ConstantsUtil {
    ...
    public static final String DESTINATARIO_NAO_EXISTE = "Usuário destinatario não encontrado";
    public static final String CPF_CPNJ_EMAIL_INVALIDO = "CPF/CPNJ e/ou Email já cadastrados";
