...
public interface UsuarioRepository extends JpaRepository<Usuario, Long> {
    ...
    @Query("SELECT new com.desafio.conta.service.dto.DadosTransferenciaDTO(u.id, (SELECT ud.id FROM Usuario ud WHERE ud.id = :idUsuarioDestinatario), c.saldo) FROM Usuario u " +
